...
resource "aws_apigatewayv2_stage" "api" {
  ...
  default_route_settings {
    throttling_burst_limit = var.api_throttle_config.burst_limit
    throttling_rate_limit  = var.api_throttle_config.rate_limit
  }
...
resource "aws_cloudwatch_metric_alarm" "lambda_errors" {
  ...
  period              = 300
  statistic           = "Sum"
  threshold           = var.cloudwatch_config.alarm_threshold
  alarm_description   = "Alerta cuando Lambda tiene más de ${var.cloudwatch_config.alarm_threshold} errores"
